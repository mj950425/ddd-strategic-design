...
| 한글명        | 영문명                        | 설명                                                        |  
|------------|----------------------------|-----------------------------------------------------------|  
| 키친 포스      | kitchen pos                | 상품과 메뉴를 관리하며 음식을 주문하고 배달하는 시스템을 의미한다.                     |  
...
| 한글명      | 영문명               | 설명                  |
|----------|-------------------|---------------------|
| 메뉴 그룹    | menu group        | 메뉴의 상위그룹을 의미한다.     |  
...
| 한글명      | 영문명            | 설명                                    |  
|----------|----------------|---------------------------------------|  
| 메뉴       | menu           | 주문의 최소 단위를 의미한다. 한 개 이상의 상품으로 구성되어있다. |  
| 메뉴 이름    | menu name      | 메뉴 그룹의 이름을 의미한다.                      |  
...
| 점유여부            | occupied                              | 주문 테이블의 점유 여부를 의미한다.          |
...
| 한글명    | 영문명        | 설명                             |  
|--------|------------|--------------------------------|
| 제공됨    | served     | 매장은 주문종류에 따라 제조가 완료된 주문을 제공한다. |  
