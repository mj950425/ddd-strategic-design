...
- 행위
    - 주문을 생성한다.
        ...
        - 주문 생성 요청의 주문 아이템 수량는 0 이상이어야 한다.
...
- 행위
    ...
    - 주문 테이블의 착석한 고객 수를 변경한다.
        - 변경 요청의 고객 수는 0 이상이어야 한다.
        - 변경 요청의 주문 테이블은 점유됨 상태이어야한다.
    - 주문 테이블을 초기화한다.
...
sequenceDiagram
    ...
    rect rgba(200, 200, 255, 0.3)
        ...
        alt 배달 또는 포장 유형의 주문인데, 주문 아이템 수량이 0보다 작음
            주문 -->> 사장님: 예외 발생
        end
        alt 메뉴가 표시되지 않음
            주문 -->> 사장님: 예외 발생
